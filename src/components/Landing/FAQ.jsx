  ...
  return (
    <section className="w-full flex flex-col items-center justify-center py-16 md:py-24 bg-transparent px-8">
      ...
      <div className="container mx-auto">
        <div className="w-full mx-auto rounded-2xl md:rounded-3xl shadow-xl bg-gradient-to-br from-[#181828] via-[#232347] to-[#181828] px-6 md:px-16 py-10 md:py-14 flex flex-col md:flex-row items-center md:items-start justify-between gap-8">
