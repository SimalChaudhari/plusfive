    ...
    <div className=" mx-auto w-full">
      <section className="w-full flex flex-col lg:flex-row items-center justify-evenly md:py-[64px] py-8 md:px-[80px] px-8 md:gap-[114px] gap-10 bg-white dark:bg-customGray rounded-3xl">
        ...
        <div className="flex-1 text-center lg:text-left">
          <h2 className="text-3xl md:text-48 font-extrabold text-customLightTextColor dark:text-white">
            {t.heading}
          </h2>
          ...
          <p className="text-lg md:text-20 font-semibold text-customLightTextColor dark:text-white mb-5">
            {t.subheading}
          </p>
          ...
          <p className="font-bold text-customBoldTextColor dark:text-white mt-6 text-base md:text-18">{t.cta}</p>
        </div>
        {/* Right: Image */}
