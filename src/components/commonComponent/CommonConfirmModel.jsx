  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white/90 dark:bg-customBlack/90 rounded-2xl shadow-2xl max-w-md w-full overflow-hidden backdrop-blur-md border border-customGray2 dark:border-customGray flex flex-col animate-fadeIn">
        ...
        <button
          onClick={handleCancel}
          className="absolute top-4 right-4 p-2 text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 transition-colors duration-200 rounded-full hover:bg-gray-100 dark:hover:bg-customGray focus:outline-none focus:ring-2 focus:ring-customRed"
          aria-label="Close"
        >
          <MdClose size={20} />
        </button>
        ...
        {/* Header with Icon */}
        <div className="px-8 pt-8 pb-4 flex items-center space-x-3">
        ...
        {/* Footer */}
        <div className="px-8 py-6 bg-gray-50/80 dark:bg-customGray/80 flex justify-end space-x-4">
          <button
            onClick={handleCancel}
